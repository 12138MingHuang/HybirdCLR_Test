...
IL2CPP_EXTERN_C String_t* _stringLiteral287F47B6BC00300244A4C91B97DB61052888CA2D;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ConsoleToScreen_Log_mA5DDFAB65C29E797A1C47CD29C6C83E3163A52EA (ConsoleToScreen_t4D4E2DA6049B115E29915B9B584C8009100A848E* __this, String_t* ___0_logString, String_t* ___1_stackTrace, int32_t ___2_type, const RuntimeMethod* method) 
{
	...
	int32_t V_4 = 0;
	{
		...
		L_1 = String_Split_m15EB0AE498D606D2ABC49FC5F1EC3E29121F8AFB(L_0, _stringLiteral00B28FF06B788B9B67C6B259800F404F9F3761FD, 0, NULL);
		V_0 = L_1;
		V_1 = 0;
		goto IL_009b;
	}
...
IL_0030:
	{
		...
		V_3 = ((int32_t)il2cpp_codegen_add(((int32_t)(L_11/((int32_t)100))), 1));
		V_4 = 0;
		goto IL_0092;
	}
...
IL_0041:
	{
		...
		if ((((int32_t)((int32_t)il2cpp_codegen_multiply(((int32_t)il2cpp_codegen_add(L_12, 1)), ((int32_t)100)))) >= ((int32_t)L_14)))
		{
			goto IL_006a;
		}
	}
	{
		...
		NullCheck(L_16);
		String_t* L_18;
		L_18 = String_Substring_mB1D94F47935D22E130FF2C01DBB6A4135FBB76CE(L_16, ((int32_t)il2cpp_codegen_multiply(L_17, ((int32_t)100))), ((int32_t)100), NULL);
		NullCheck(L_15);
...
IL_006a:
	{
		...
		NullCheck(L_20);
		String_t* L_25;
		L_25 = String_Substring_mB1D94F47935D22E130FF2C01DBB6A4135FBB76CE(L_20, ((int32_t)il2cpp_codegen_multiply(L_21, ((int32_t)100))), ((int32_t)il2cpp_codegen_subtract(L_23, ((int32_t)il2cpp_codegen_multiply(L_24, ((int32_t)100))))), NULL);
		NullCheck(L_19);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void LoadDll_LoadMetadataForAOTAssemblies_mC274B051DF0C7057D2B4C75EFBC99C90782791F3 (const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral287F47B6BC00300244A4C91B97DB61052888CA2D);
...
IL_002e_1:
			{
				...
				String_t* L_7 = V_1;
				String_t* L_8;
				L_8 = String_Concat_m093934F71A9B351911EE46311674ED463B180006(L_6, _stringLiteral86BBAACC00198DBB3046818AD3FC2AA10AE48DE1, L_7, _stringLiteralEC4C5477D8BA260A27C36AFD7E8C1C289169E9CF, NULL);
				...
				String_t* L_15;
				L_15 = String_Format_mFB7DA489BD99F4670881FF50EC017BFB0A5C0987(_stringLiteral287F47B6BC00300244A4C91B97DB61052888CA2D, L_11, L_14, NULL);
